...
class getDoctrine_Orm_DefaultEntityManagerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        $b->addDriver(($container->privates['doctrine.orm.default_attribute_metadata_driver'] ??= new \Doctrine\ORM\Mapping\Driver\AttributeDriver([(\dirname(__DIR__, 4).'/src/Domain/Entity')], true)), 'App\\Domain\\Entity');

        $a->setEntityNamespaces(['App' => 'App\\Domain\\Entity']);
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($container->getService ??= $container->getService(...), [
            'App\\Infrastructure\\Repository\\NewsRepository' => ['privates', 'App\\Infrastructure\\Repository\\NewsRepository', 'getNewsRepositoryService', true],
        ], [
            'App\\Infrastructure\\Repository\\NewsRepository' => '?',
        ])));
